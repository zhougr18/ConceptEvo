...
def parse_arguments():
    ...
    parser.add_argument('--video_feats_path', type=str, default='video_feats.pkl', help="The directory of the video features.")  # swin_feats.pkl video_feats.pkl
    ...
    parser.add_argument('--method', type=str, default='mag_bert', help="which method to use (mult, misa, mag_bert, tcl-map sdif-da).")  # mag_bert mult
    ...
    parser.add_argument('--gpu_id', type=str, default='3', help="The used gpu index of your device.")
