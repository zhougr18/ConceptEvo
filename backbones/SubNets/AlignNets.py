...
class SimModule(nn.Module):
    ...
    def forward(self, x, y):
        ...
        '''
        # now: tcl_map
        pseudo_aligned_out = self.ctc(x)  # [16,37,768]<-[16,3,768]
        ...
        y_norm = y_common / torch.max(y_n, self.eps * torch.ones_like(y_n))  # normalization  [16,3,256]
        ...
        logits = self.sigmoid(logits)  # [16,3,37]
        
        aligned_out = torch.bmm(logits, pseudo_aligned_out)  # [16,3,768]
