...
from .evolution_ConceptEvo_GPT import concepts_init, concepts_evolution
...
class ConceptEvo_GPT:
    ...
    def __init__(self, args, data, model):
        ...
        # Initialize concept set and history via GPT-4
        self.key_concepts, self.history = concepts_init()
    ...
    def _train(self, args): 
        ...
        Each epoch:
          ...
          3. Use GPT-4 to evolve concepts based on feedback (D_score + S_score).
        ...
        for epoch in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            # Concept evolution via GPT-4
            result = concepts_evolution(
                self.history, self.key_concepts,
